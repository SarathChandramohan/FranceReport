...
// Replaced the primary blue with a violet color, making it the new default.
$predefined_colors = ['#6A0DAD', '#34c759', '#ff9500', '#5856d6', '#ff3b30', '#9370DB', '#ffcc00', '#8e8e93', '#ff2d55', '#00a096'];
...
<head>
    ...
    <style>
        ...
        .mission-card.validated { opacity: 0.8; background-color: #e6ffed; } /* Kept as green */
        ...
        .action-btn.validate-btn.validated { color: #28a545; } /* Kept as green */
        ...
        /* --- VIOLET THEME OVERRIDES FOR BOOTSTRAP BLUES --- */
