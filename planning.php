...
// Replaced blue and green colors with a violet palette
$predefined_colors = ['#6A0DAD', '#8A2BE2', '#ff9500', '#5856d6', '#ff3b30', '#9370DB', '#ffcc00', '#8e8e93', '#ff2d55', '#4B0082'];
...
<head>
    ...
    <style>
        ...
        :root { --primary: #6A0DAD; --light-gray: #f0f2f5; --card-bg: #ffffff; --border-color: #dee2e6; --dark-yellow: #ffc107; --light-yellow: #fff8e1;}
        ...
        /* Validated color changed from light green to light violet */
        ...
        /* --- VIOLET THEME OVERRIDES FOR BOOTSTRAP --- */
        .btn-primary { background-color: var(--primary); border-color: var(--primary); color: white; }
        .btn-primary:hover { background-color: #581894; border-color: #4c147c; }
        .btn-success { background-color: #8A2BE2; border-color: #8A2BE2; color: white; }
        .btn-success:hover { background-color: #7925c9; border-color: #6e22b5; }
        .btn-info { background-color: #9370DB; border-color: #9370DB; color: white; }
        .btn-info:hover { background-color: #825bcd; border-color: #7650c1; }
        .badge-primary { background-color: var(--primary); color: white; }
        .badge-info { background-color: #9370DB; color: white; }
        .text-primary { color: var(--primary) !important; }
        .alert-info { background-color: #f3e8ff; color: #493c55; border-color: #e9d8f8; }
    </style>
</head>
<body>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderPlanningGrid() {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            // Plus button color changed from hardcoded blue to use CSS variable for violet theme
            const plusButton = `<button class="btn ml-2 add-mission-btn" data-date="${dateStr}" style="background-color: #ffffff; color: var(--primary); border: 1px solid #dee2e6; border-radius: 50%; width: 28px; height: 28px; display: inline-flex; align-items: center; justify-content: center; padding: 0; line-height: 1;"><i class="fas fa-plus" style="font-size: 14px;"></i></button>`;
    ...
    function renderAssignedWorkersInModal() {
        ...
        // Badge class changed from badge-primary to use new violet style
    ...
    function updateAssignedAssetsDisplay() {
        ...
        if (assignedAssetsInModal.length > 0) {
            assignedAssetsInModal.forEach(asset => {
                ...
                // Badge class changed from badge-info to use new violet style
