...
if ($user['role'] !== 'admin') {
    // Redirect non-admin users or show an error
    header('Location: dashboard.php'); // Or your main user page
    exit;
}
?>
<!DOCTYPE html>
                        ...
                        <div id="tool-fields">
                             <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="serial_or_plate_tool" name="serial_or_plate" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Emplacement</label>
                                    <input type="text" id="position_or_info_tool" name="position_or_info" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="vehicle-fields">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="serial_or_plate_vehicle" name="serial_or_plate" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
