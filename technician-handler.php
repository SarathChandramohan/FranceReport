...
<script>
                ...
                <li>
                    ...
                    ${ isCheckedOut
                        ...
                        : `<div class="custom-control custom-checkbox ml-3">
                               <input type="checkbox" class="custom-control-input checkout-checkbox" id="item-${item.asset_id}" value="${item.asset_id}" data-booking-id="${item.booking_id}">
    ...
    function handleCheckout() {
        const selectedItems = [];
        $('#assigned-items-list .checkout-checkbox:checked').each(function() {
            selectedItems.push({
                asset_id: $(this).val(),
