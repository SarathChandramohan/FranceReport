<?php 
 ...
 <style> 
    ...
    /* --- START: MODERN NOTIFICATION ITEM STYLES (REPLACED) --- */
    .notification-item {
        display: flex;
    ...
    /* --- END: MODERN NOTIFICATION ITEM STYLES --- */
 ...
 <script> 
 	document.addEventListener('DOMContentLoaded', function () { 
        ...
        // --- START: UPDATED JAVASCRIPT FUNCTION ---
 		...
 		function renderNotifications(notifications) { 
 			...
 			notifications.forEach(function(notif) { 
 				// Add a dot if the notification is unread
 				const unreadDot = notif.is_read == 0 ? '<div class="unread-dot"></div>' : '';
 				// Use a generic icon; you could change this based on notification type
 				const iconClass = 'fa-bell'; 
 
 				// Use a <div> instead of an <a> tag to make it non-clickable
        ...
        // --- END: UPDATED JAVASCRIPT FUNCTION ---
