...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"; }
        ...
        #congesAdminModal .nav-tabs .nav-link { border-radius: 0.25rem 0.25rem 0 0; color: #6A0DAD; }
        ...
        #leaveDetailsModal .document-link-modal { display: inline-block; margin-top: 5px; padding: 5px 10px; background-color: #f0f2f5; border-radius: 5px; color: #6A0DAD; text-decoration: none; }
